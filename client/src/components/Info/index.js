            ...
            <div className="col s12 m6">
                <div className="#a5d6a7 green lighten-3">
                    ...
                    <div className="card-action">
                        <a className="waves-effect waves-light btn #2e7d32 green darken-3" style={{ margin: 5, marginLeft: 400 }} onClick={props.handleSave} >Save</a>
